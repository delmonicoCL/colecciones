      ...
      <section class="imagenHeader ">
            <div class="row py-lg-5 ">
                <div class="col-lg-6 col-md-8 mx-auto ">
                    <h1 class="fw-light d-flex justify-content-center">ARTISTAS</h1>
        ...
        <div id="menuAjustes">
            <div class="collapse" id="navbarToggleExternalContent">
                <div class="bg-dark p-4 py-3 mt-4">
                    <h2 class="text-white d-flex justify-content-center">Opciones Artistas</h2>
        ...
        <div class="container my-5">
            <h5 class="display-5 d-flex justify-content-center ">Lista de Artistas</h5>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalEliminarLabel">Eliminar Artista</h5>
        ...
        <div class="modal fade" id="ModalActualizar" tabindex="-1" aria-labelledby="ModalActualizar" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalActualizarLabel">Actualizar Nombre Artista</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="./php_controllers/listaController.php" method="POST">
        ...
        <div class="modal fade" id="ModalAgregar" tabindex="-1" aria-labelledby="ModalAgregar" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalAgregarLabel">Agregar Artista</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="./php_controllers/listaController.php" method="POST"
                            ...
                            <!-- <div class="form-group">
                                ...
                                <label for="ID_Artista">Artistas Agregados</label>
                                <select class="form-select" name="ID_Artista">
                                    <?php foreach ($artistas as $artista): ?>
                                    <option value="<?php echo $artista['ID_Artista']; ?>">
                                        <?php echo $artista['Nombre']; ?>
                            ...
                            <div class="form-group">
                                <label for="Nombre">Nuevo Artista</label>
                                <input type="text" class="form-control" id="Nombre" name="Nombre"
