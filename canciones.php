        ...
        <section class="imagenHeader ">
            <div class="row py-lg-5 ">
                <div class="col-lg-6 col-md-8 mx-auto ">
                    <h1 class="fw-light d-flex justify-content-center">CANCIONES</h1>
        ...
        <div id="menuAjustes">
            <div class="collapse" id="navbarToggleExternalContent">
                <div class="bg-dark p-4 py-3 mt-4">
                    <h2 class="text-white d-flex justify-content-center">Opciones Canciones</h2>
    ...
    <tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalEliminarLabel">Eliminar Canciones</h5>
        ...
        <div class="modal fade" id="ModalActualizar" tabindex="-1" aria-labelledby="ModalActualizar" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalActualizarLabel">Actualizar Canciones</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="./php_controllers/cancionController.php" method="POST">
       ...
       <div class="modal fade" id="ModalAgregar" tabindex="-1" aria-labelledby="ModalAgregar" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="ModalAgregarLabel">Agregar Cancion</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
